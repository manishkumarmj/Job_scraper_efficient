...
async def main():
    ...
    for entry in inputs:
        ...
        for location in entry["locations"]:
            print(f"Scraping Indeed for {role} in {location}...")
            jobs = await scrape_indeed(role, location, hours=hours, max_pages=1)
    ...
    output_file = f"results/indeed_{hours}h_{timestamp}.xlsx"
